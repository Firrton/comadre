...
describe("buildConfirmationPrompt", () => {
  ...
  it("builds the canonical reprompt and success replies", () => {
    expect(buildConfirmationReprompt("+59171234567", "12.50")).toBe(
      "Tenés un envío pendiente de 12.50 USDC a +59171234567. Respondé SÍ o NO.",
    );
    expect(buildConfirmationSuccessReply("+59171234567", "12.50")).toBe(
      "Listo, envié 12.50 USDC a +59171234567.",
    );
  });
});
